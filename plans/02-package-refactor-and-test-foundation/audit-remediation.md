...
2. Restore retry-both behavior in
...
4. Revert the stage-02 spec amendment to `02-api-clients.md` §3.3
   (which codified 403-raises-immediately), with user approval.
5. Augment `test_rate_limit_429_is_retried_then_terminates_with_rate_limit_error`
